...
// In web mode, HTML rendering is available.
type Handler struct {
	repo     domain.PaymentRepository
	renderer *views.Renderer
}

// NewHandler creates a new dashboard handler (web mode).
func NewHandler(repo domain.PaymentRepository, renderer *views.Renderer) *Handler {
	return &Handler{
		repo:     repo,
		renderer: renderer,
	}
